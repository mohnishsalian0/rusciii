    ...
    F: Fn(Event) + 'static,
{
    ...
    view! {
        <button class="w-full relative aspect-video" on:click=onClick>
            <div class="absolute inset-0 p-2 border border-dashed border-neutral-300 rounded-md flex flex-col justify-center">
                <h4 class="text-base text-center text-neutral-500">Upload image</h4>
                <p class="text-sm font-extralight text-neutral-400 text-center">
